...
class SmoothMachineStatusLoaded extends SmoothMachineStatus {
    onEnter() {
        this.relMachine.rel.argsSmooth.init(this.relMachine.assetsImg.image, 1, 1, this.relMachine.dataInst.paddingTop, this.relMachine.dataInst.paddingRight, this.relMachine.dataInst.paddingBottom, this.relMachine.dataInst.paddingLeft, this.relMachine.dataInst.pixelWidth, this.relMachine.dataInst.pixelHeight);
