...
export default class DomDrawingBoardRightPaintCanvas extends ReactComponentExtend {
    render() {
        let img;
        ...
        }, ReactComponentExtend.instantiateComponent(DomInputNumberApplicationHor, DomInputNumberApplicationHor.Args.create(`像素尺寸 1 : ${MgrData.inst.get(MgrDataItem.DB_PIXEL_TO_SCREEN_APPLICATION)}`, MgrData.inst.get(MgrDataItem.DB_PIXEL_TO_SCREEN_TEMP), null, null, (val) => {
