...
class DomExperimentRightPreviewImgBefore extends ReactComponentExtend {
    render() {
        ...
        }, ReactComponentExtend.instantiateComponent(DomInputNumberHor, DomInputNumberHor.Args.create(`左内边距`, listImgDataInst.paddingLeft, (val) => {
            IndexGlobal.mcExp().statusPreview.imgMachine.currStatus.onValPaddingLeft(Math.floor(val));
        }, null, null)), ReactComponentExtend.instantiateComponent(DomInputNumberHor, DomInputNumberHor.Args.create(`右内边距`, listImgDataInst.paddingRight, (val) => {
        ...
        }, ReactComponentExtend.instantiateComponent(DomInputNumberHor, DomInputNumberHor.Args.create(`上内边距`, listImgDataInst.paddingTop, (val) => {
            IndexGlobal.mcExp().statusPreview.imgMachine.currStatus.onValPaddingTop(Math.floor(val));
        }, null, null)), ReactComponentExtend.instantiateComponent(DomInputNumberHor, DomInputNumberHor.Args.create(`下内边距`, listImgDataInst.paddingBottom, (val) => {
        ...
        }, ReactComponentExtend.instantiateComponent(DomInputNumberHor, DomInputNumberHor.Args.create(`颗粒宽度`, listImgDataInst.pixelWidth, (val) => {
        ...
        }, 1, null)), ReactComponentExtend.instantiateComponent(DomInputNumberHor, DomInputNumberHor.Args.create(`颗粒高度`, listImgDataInst.pixelHeight, (val) => {
