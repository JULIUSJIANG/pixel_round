...
class DomExperimentRightSmooth extends ReactComponentExtend {
    render() {
        ...
        ;
        let domImageSmoothArgs = DomImageSmooth.Args.create(DomImageSmoothRS.exp, resImg, 1, 1, dataSrc.imgMachine.dataInst.paddingTop, dataSrc.imgMachine.dataInst.paddingRight, dataSrc.imgMachine.dataInst.paddingBottom, dataSrc.imgMachine.dataInst.paddingLeft, dataSrc.imgMachine.dataInst.pixelWidth, dataSrc.imgMachine.dataInst.pixelHeight);
