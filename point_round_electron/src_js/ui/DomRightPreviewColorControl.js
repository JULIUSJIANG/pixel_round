...
class DomRightPreviewColorControl extends ReactComponentExtend {
    render() {
...
(function (DomRightPreviewColorControl) {
    class Args {
        static create(idx) {
    ...
    DomRightPreviewColorControl.Args = Args;
})(DomRightPreviewColorControl || (DomRightPreviewColorControl = {}));
