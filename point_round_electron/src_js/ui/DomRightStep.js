...
class DomRightStep extends ReactComponentExtend {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        }, ReactComponentExtend.instantiateComponent(IndexGlobal.inst.stepRSCurrent.comGetter(), null), ReactComponentExtend.instantiateTag(MgrDomDefine.TAG_DIV, {
            style: {
                [MgrDomDefine.STYLE_MARGIN]: MgrDomDefine.CONFIG_TXT_HALF_SPACING,
