...
const Z_GRID = 0.1;
class DomRightStep4MergeReduce extends ReactComponentExtend {
    constructor() {
        super(...arguments);
        /**
         * 3d canvas 引用器
    ...
    reactComponentExtendOnDraw() {
        ...
        for (let i = 0; i < IndexGlobal.inst.detailMachine.statusPreview.listImgPixelGroupAllNotEmpty.length; i++) {
            ...
            this.jWebgl.programImgDyeing.add(this.posImg, JWebglMathVector4.axisZStart, JWebglMathVector4.axisYEnd, fboWidth, fboHeight);
...
export default DomRightStep4MergeReduce;
