 ...
 * 替换某些短距平滑为长距平滑
 */
export default class JWebglProgramTypeSmoothEnumInit extends JWebglProgram {
...
void main() {
    ...
    vec4 colorCorner = getCornerCache (pos, vec2 (0.0, 0.0));
    vec4 colorEnum = getEnumCache (pos, vec2 (0.0, 0.0));

    // 仅针对有平滑的情况
    colorEnum.a = colorCorner.a;
    gl_FragColor = colorEnum;
}
        `;
    }
