...
import ReactComponentExtendInstance from "./ReactComponentExtendInstance";

const SYM_BOL = Symbol (`ReactComponentExtend`);

const com = NodeModules.react.Component as any;
/**
 * react 组件的拓展
 */
abstract class ReactComponentExtend <T> extends com {
    /**
     * 参数
     */
    props: T;
...
namespace ReactComponentExtend {
     ...
     * @returns 
     */
    export function instantiateTag (component: string | any, props: any, ...args)
    {
    ...
    {
        return NodeModules.react.createElement (component as any, props) as ReactComponentExtendInstance;
    }
}
