...
import DomDrawingBoardLeftListImg from "./DomDrawingBoardLeftListImg";
    ...
    render (): ReactComponentExtendInstance {
        ...
        for (let i = 0; i < listImgData.length; i+= rsCurrent.count) {
            ...
            for (let j = 0; j < rsCurrent.count; j++) {
                ...
                let args = objectPool.pop (DomDrawingBoardLeftListImg.Args.poolType);
                args.init (imgData, i, j);
                this.listChildrenContainer.push (ReactComponentExtend.instantiateComponent (DomDrawingBoardLeftListImg, args));
            };
