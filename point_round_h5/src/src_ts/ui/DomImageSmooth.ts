...
class DomImageSmooth extends ReactComponentExtend <DomImageSmooth.Args> {
     ...
     * 各个角对于平滑颜色的选择
     */
    fboColorSelect: JWebglFrameBuffer;
    /**
     * 存储了角信息的帧缓冲区
     */
    ...
    /**
     * 存储了平滑类型的帧缓冲区，r 为正数的时候说明平滑左倾斜，g 为正数的时候说明平滑右倾斜
     */
     ...
     * 记录当前角是否指向圆心
     */
    fboDirection: JWebglFrameBuffer;
    /**
     * 记录当前角是否指向圆心 - 备份
     */
    fboDirectionCache: JWebglFrameBuffer;
    ...
    reactComponentExtendOnDraw (): void {
        ...
        if (this.fboTexture == null || this.fboTexture.width != this.props.cacheTexWidth || this.fboTexture.height != this.props.cacheTexHeight) {
            ...
            this.jWebgl.destroyFbo (this.fboColorSelect);
            this.fboColorSelect = this.jWebgl.getFbo (this.props.cacheTexWidth * 2, this.props.cacheTexHeight * 2, JWebglEnum.TexParameteriParam.NEAREST);
            ...
            this.jWebgl.destroyFbo (this.fboDirection);
            this.fboDirection = this.jWebgl.getFbo (this.props.cacheTexWidth * 2, this.props.cacheTexHeight * 2, JWebglEnum.TexParameteriParam.NEAREST);
            this.jWebgl.destroyFbo (this.fboDirectionCache);
            this.fboDirectionCache = this.jWebgl.getFbo (this.props.cacheTexWidth * 2, this.props.cacheTexHeight * 2, JWebglEnum.TexParameteriParam.NEAREST);
        };
    ...
    step8EnumSmooth (posX: number, posY: number) {
        ...
        this.jWebgl.programSmoothEnumSideAddition.uTextureSize.fill (this.props.cacheTexWidth, this.props.cacheTexHeight);
        this.jWebgl.programSmoothEnumSideAddition.uTextureMain.fillByFbo (this.fboTexture);
        this.jWebgl.programSmoothEnumSideAddition.uTextureCorner.fillByFbo (this.fboCornerData);
        this.jWebgl.programSmoothEnumSideAddition.uTextureEnum.fillByFbo (this.fboEnumData);
        this.jWebgl.programSmoothEnumSideAddition.uRight.fill (1);
        this.jWebgl.programSmoothEnumSideAddition.add (
            JWebglMathVector4.centerO,
            JWebglMathVector4.axisZStart,
            JWebglMathVector4.axisYEnd,
            2,
     ...
     * @param posY 
     */
    step8Direction (posX: number, posY: number) {
        this.jWebgl.useFbo (this.fboDirection);
        this.jWebgl.clear ();
        let countIterator = Math.ceil (Math.max (this.props.cacheTexWidth, this.props.cacheTexHeight) / 2);
        // let countIterator = 1;
        for (let i = 0; i < countIterator; i++) {
            this.jWebgl.useFbo (this.fboDirectionCache);
            this.jWebgl.clear ();
            this.jWebgl.programSmoothDirection.uMvp.fill (this.mat4Mvp);
            this.jWebgl.programSmoothDirection.uTextureSize.fill (this.props.cacheTexWidth, this.props.cacheTexHeight);
            this.jWebgl.programSmoothDirection.uTextureCorner.fillByFbo (this.fboCornerData);
            this.jWebgl.programSmoothDirection.uTextureEnum.fillByFbo (this.fboEnumData);
            this.jWebgl.programSmoothDirection.uTextureDirection.fillByFbo (this.fboDirection);
            this.jWebgl.programSmoothDirection.add (
                JWebglMathVector4.centerO,
                JWebglMathVector4.axisZStart,
                JWebglMathVector4.axisYEnd,
                2,
            ...
            this.jWebgl.programSmoothDirection.draw ();
            this.jWebgl.fillFboByFbo (this.fboDirection, this.fboDirectionCache);
        };
        IndexGlobal.smoothRS ().expDrawFbo (this, this.fboDirection, posX, posY + 1);
        IndexGlobal.smoothRS ().expSmoothOrdinaryTo (this, posX, posY + 0);
    }
    ...
    updateFboSelect () {
        ...
        this.jWebgl.programSmoothColorSelect.uTextureSize.fill (this.props.cacheTexWidth, this.props.cacheTexHeight);
        this.jWebgl.programSmoothColorSelect.uTextureMain.fillByFbo (this.fboTexture);
        this.jWebgl.programSmoothColorSelect.uTextureCorner.fillByFbo (this.fboCornerData);
        this.jWebgl.programSmoothColorSelect.uTextureEnum.fillByFbo (this.fboEnumData);
        this.jWebgl.programSmoothColorSelect.uRight.fill (1);
        this.jWebgl.programSmoothColorSelect.add (
            JWebglMathVector4.centerO,
            JWebglMathVector4.axisZStart,
            JWebglMathVector4.axisYEnd,
            2,
