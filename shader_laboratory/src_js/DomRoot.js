...
export default class DomRoot extends ReactComponentExtend {
    ...
    reactComponentExtendOnDraw() {
        ...
        this.jWebgl.programPosToColor.add(JWebglMathVector4.centerO, JWebglMathVector4.axisZStart, JWebglMathVector4.axisYEnd, WIDTH, HEIGHT);
        ...
        this.jWebgl.programImg.add(JWebglMathVector4.centerO, JWebglMathVector4.axisZStart, JWebglMathVector4.axisYEnd, WIDTH, HEIGHT);
