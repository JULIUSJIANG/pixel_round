...
export default class JWebglProgramTypeImgDyeing extends JWebglProgram {
    constructor() {
        super(...arguments);
...
void main() {
    ...
    impGetnShaderFTxt() {
        return `
void main() {
    vec4 texColor = texture2D(${this.uSampler}, ${this.vTexCoord});
    if (texColor.a == 0.0) {
        discard;
    };
...
], JWebglProgramTypeImgDyeing.prototype, "uMvp", void 0);
__decorate([
    JWebglProgram.uniform(JWebglProgramUniformSampler2D)
], JWebglProgramTypeImgDyeing.prototype, "uSampler", void 0);
__decorate([
    JWebglProgram.uniform(JWebglProgramUniformVec4)
], JWebglProgramTypeImgDyeing.prototype, "uColor", void 0);
__decorate([
    JWebglProgram.attribute(JWebglProgramAttributeVec4)
], JWebglProgramTypeImgDyeing.prototype, "aPosition", void 0);
__decorate([
    JWebglProgram.attribute(JWebglProgramAttributeVec2)
], JWebglProgramTypeImgDyeing.prototype, "aTexCoord", void 0);
__decorate([
    JWebglProgram.varying(JWebglProgramVaryingVec2)
], JWebglProgramTypeImgDyeing.prototype, "vTexCoord", void 0);
