...
export default class JWebglProgramTypeRound extends JWebglProgram {
    constructor() {
        super(...arguments);
...
void main() {
    ...
    impGetnShaderFTxt() {
        return `
void main() {
    float unit = 1.0 / ${this.uPixelCount};
    vec2 pos = (floor (${this.vTexCoord} / unit) + vec2 (0.5, 0.5)) * unit;
...
], JWebglProgramTypeRound.prototype, "uMvp", void 0);
__decorate([
    JWebglProgram.uniform(JWebglProgramUniformFloat)
], JWebglProgramTypeRound.prototype, "uPixelCount", void 0);
__decorate([
    JWebglProgram.attribute(JWebglProgramAttributeVec4)
], JWebglProgramTypeRound.prototype, "aPosition", void 0);
__decorate([
    JWebglProgram.attribute(JWebglProgramAttributeVec2)
], JWebglProgramTypeRound.prototype, "aTexCoord", void 0);
__decorate([
    JWebglProgram.varying(JWebglProgramVaryingVec2)
], JWebglProgramTypeRound.prototype, "vTexCoord", void 0);
