...
export default class DomRightCreate extends ReactComponentExtend {
    ...
    render() {
        ...
        }, ReactComponentExtend.instantiateTag(NodeModules.antd.Upload.Dragger, {}, ReactComponentExtend.instantiateTag(MgrDomDefine.TAG_DIV, {
            style: {
                [MgrDomDefine.STYLE_COLOR]: MgrDomDefine.STYLE_COLOR_WHITE
            }
        }, `拖拽文件到这里或通过点击选择文件，仅支持 .jpg、.png 格式`))), ReactComponentExtend.instantiateTag(NodeModules.antd.Button, {
            style: {
                [MgrDomDefine.STYLE_FLEX_GROW]: 0,
                [MgrDomDefine.STYLE_MARGIN]: MgrDomDefine.CONFIG_TXT_HALF_SPACING
            }
